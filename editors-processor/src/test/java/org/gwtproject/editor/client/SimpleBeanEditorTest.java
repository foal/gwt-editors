...
import org.gwtproject.editor.client.imm.ModifiableConnection;
...
public class SimpleBeanEditorTest extends TestCase {
  ...
  interface DepartmentWithListEditorDriver
	...
	static class ConEditor implements Editor<ModifiableConnection> {

		SimpleEditor<String> color = SimpleEditor.of(UNINITIALIZED);

	}

	@IsDriver
	interface ConEditorDriver
			extends SimpleBeanEditorDriver<ModifiableConnection, ConEditor> {
	}
